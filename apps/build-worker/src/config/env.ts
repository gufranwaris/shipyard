...
const env = {
  ...
  rabbitmqExchange: process.env.RABBITMQ_EXCHANGE || "deployments.build.exchange",
  rabbitmqBuildQueue: process.env.RABBITMQ_BUILD_QUEUE || "deployments.build.queue",
  rabbitmqBuildRoutingKey: process.env.RABBITMQ_BUILD_ROUTING_KEY || "deployment.build.created",
